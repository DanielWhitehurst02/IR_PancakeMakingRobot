function Main(app)
    ...
    motionHandler2 = MotionHandlerWIthGripperAndObjects(robot2, centerPoints2, radii2, cubePoints, leftFinger2, rightFinger2,troty(-pi/2) * trotz(-pi),transl(0,0.15,0),app);
