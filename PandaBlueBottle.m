...
endTr1 = transl(0.8,1.1,1.05)*troty(pi/2);
% Example target transformation
...
steps=50;
      ...
      % Calculate pick-up and drop joint angles based on current robot configuration
        qpick = robot.model.ikine(transl(pick)*troty(pi/2)*trotx(pi/2), 'q0', q, 'mask', [1,1,1,0,0,1]);
